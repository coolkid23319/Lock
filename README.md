...
do
	local Window = library:AddWindow("Zephy.lua", {
	...
	local Tab = Window:AddTab("Camera")
	local WsgCuh = Window:AddTab("Silent")
	local Teb = Window:AddTab("Target")
	local Tib = Window:AddTab("Miscs")
	local Tub = Window:AddTab("Debugging/Cred")
...
Droeopdown:Add("Head")
	...
	Tab:AddTextBox("Smoothness", function(text)
...
local ShakeFolder = Tab:AddFolder("Shake Configuration")
	ShakeFolder:AddTextBox("X", function(text)
		getgenv().ShakeX = text
		end, 
	{
	["clear"] = false, -- Default: true (options are optional)
	})
	ShakeFolder:AddTextBox("Y", function(text)
		getgenv().ShakeY = text
		end, 
	{
	["clear"] = false, -- Default: true (options are optional)
	})
	ShakeFolder:AddTextBox("Z", function(text)
		getgenv().ShakeZ = text
		end, 
	{
	["clear"] = false, -- Default: true (options are optional)
